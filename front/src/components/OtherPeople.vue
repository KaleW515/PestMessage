    ...
    export default {
        ...
        data() {
            return {
                myName: "",
                name: "",
                imageUrl: axios.defaults.baseURL+"/getOtherAva",
                signature: "",
                MessageNum: 0,
                likeNum: 0,
                disLikeNum: 0,
        ...
        methods: {
            ...
            openMyMessageReply() {
                ...
                this.axios({
                    method: "get",
                    url: "/watchMyReply?phoneNumber=" + this.$route.query.phoneNumber,
                })
                    .then(function (response) {
                            that.message = response.data.pageNow;
                            that.total = 5 * parseInt(response.data.pageCount);
            ...
            init() {
                let that = this;
                this.imageUrl = axios.defaults.baseURL+"/getOtherAva?username=" + this.$route.query.username;
                this.axios({
                    method: "get",
                    url: "/getOtherInfo?phoneNumber=" + this.$route.query.phoneNumber,
                })
                    .then(function (response) {
